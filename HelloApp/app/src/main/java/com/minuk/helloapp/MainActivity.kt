...
import com.minuk.helloapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    /*
    안드로이드 어플이 시작될때 자동으로 호출되는 method
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*
        Activity_main.xml 을 확장하여 객체변수처럼 사용할수 있도록 만드는 과정
         */
        ...
        binding.fab.setOnClickListener { view ->
            ...
            // 보통때는 표시되는 위치가 거의 같다
            // 하지만 화면에 키보드가 있을때는
            // Snackbar 와 Toast 는 표시되는 위치가 약간 다르게 보인다
